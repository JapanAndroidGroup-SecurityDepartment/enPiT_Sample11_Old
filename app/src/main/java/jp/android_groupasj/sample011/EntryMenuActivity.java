...
import jp.android_groupasj.sample011.model.EntryModel;

import java.util.ArrayList;

public class EntryMenuActivity extends BaseAppCompatActivity {
    /** ログ出力用 */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mAutherUserID == 0) {
            Toast.makeText(mContext, R.string.no_login_error, Toast.LENGTH_LONG);
        }
        GetEntryModels();
    }
